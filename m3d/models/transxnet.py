...
try:
    ...
    # MMCV 2 moved runner/checkpoint utilities to MMEngine.
...
def transxnet_s(pretrained=False, pretrained_cfg=None, **kwargs):
    ...
    model.default_cfg = _cfg(crop_pct=0.9)
    if pretrained:
        ckpt = 'https://github.com/LMMMEng/TransXNet/releases/download/v1.0/transx-s.pth.tar'
        load_checkpoint(model, ckpt)
    return model
...
def transxnet_b(pretrained=False, pretrained_cfg=None, **kwargs):
    ...
    if pretrained:
        ckpt = 'https://github.com/LMMMEng/TransXNet/releases/download/v1.0/transx-b.pth.tar'
        load_checkpoint(model, ckpt)
    return model
